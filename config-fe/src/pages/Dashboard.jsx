...
import {
  LoadVideoSources,
  AddVideoSource
} from "store/modules/video_sources/sourcesSlice";
...
export const DashboardWithStyles = withStyles(useStyles)(Dashboard);

export default connect(mapStateToProps, mapDispatch)(DashboardWithStyles);
