...
#lib = CDLL("/home/openremote/Desktop/darknet-master/build-release/libdark.so", RTLD_GLOBAL)
...
if os.name == "nt":
    ...
    lib = CDLL("/home/openremote/Desktop/or-objectdetection/YOLO_DETECTION/libdarknet.so", RTLD_GLOBAL)
